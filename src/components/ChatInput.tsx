...
export const ChatInput = ({ onSendMessage, isLoading, disabled }: ChatInputProps) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="p-4 border-t border-border/20 bg-white/80 backdrop-blur-xl">
        ...
        <div className="flex-1 relative">
          <Textarea
            ...
            className={cn(
              ...
              "bg-gray-50/80 backdrop-blur-sm text-foreground placeholder:text-muted-foreground",
